...
<body>
  ...
  <div class="login">
    <h2>Login</h2>
    <p>My Name is Abhishek Pratap Singh. This is a simple ChatRoom where anyone can enter by using a Name and any ten digit Number and interact with each Other </p>
